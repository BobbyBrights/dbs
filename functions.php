...
function my_acf_init() {
	acf_update_setting('google_api_key', 'AIzaSyAf_Wlb9xy9a6gg2xvZ2Wt03-rDM-JzQR4');
}
...
function dbs_scripts() {
  ...
  // font
	...
	// rellax
	wp_enqueue_script( 'dbs__rellax', get_template_directory_uri() . '/js/rellax/rellax.min.js', array(), true );

	// scroll reveal
	wp_enqueue_script( 'dbs__scroll-reveal', get_template_directory_uri() . '/js/scrollreveal/dist/scrollreveal.min.js', array(), true );

	wp_enqueue_style( 'dbs-style', get_template_directory_uri() . '/css/style.css');
	...
	// Contact Page
	wp_enqueue_style( 'dbs-contact-style', get_template_directory_uri() . '/css/contact.css' );	
	wp_enqueue_script( 'dbs-googlemaps-js', get_template_directory_uri() . '/js/googlemaps.js', array(), true );	
	...
	wp_enqueue_script( 'dbs__slick-js', get_template_directory_uri() . '/js/slick/slick/slick.min.js', '2017', true );
